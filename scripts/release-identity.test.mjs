...
describe('assertReleaseManifest', () => {
  it('accepts the exact plugin name and package version', () => {
    ...
    ).toEqual({ name: 'animus-environment-railway', version: '0.4.24' });
  });
  ...
  it('rejects a stale executable version', () => {
    ...
    ).toThrow('refusing to release animus-environment-railway@0.4.23 as 0.4.24');
  });

  it('rejects an unexpected plugin name', () => {
    expect(() =>
      assertReleaseManifest(JSON.stringify({ name: 'wrong-plugin', version: '0.4.24' }), expected),
